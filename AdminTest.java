...
public class AdminTest {
	...
	void testRegisterAdmin()
	{
		...
		Admin admin=Admin.builder().aName("Shyam").email("shyam124@gmail.com").UserName("shyaml124").password("124").role("ADMIN").build();
...
//		assertThat(adto.getAName()).isEqualTo("Shyam");
//	}
...
//		Transaction tx=session.beginTransaction();
//		Admin ad=new Admin();
//		ad.setAName("Shyam Sundar");
//		ad.setEmail("shyamsundar1999@gmail.com");
//		ad.setUserName("shyam124");
//		ad.setPassword("shy124");
//		AdminDTO adto=adminService.updateAdmin(4, ad);
//		tx.commit();
//		assertThat(adto.getAName()).isEqualTo("Shyam Sundar");
//		}
